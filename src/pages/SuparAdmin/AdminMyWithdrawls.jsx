...
const AdminMyWithdrawls = () => {
    ...
    const Getwalletbalances = () => {
        ...
        const token = JSON.parse(localStorage.getItem("token")) || "";
        let url = `${BaseUrl}/api/session/allsession-revenue`;
        fetch(url, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
    ...
    return (
        <div className='flex gap-[30px]'>
            <div className="max-sm:hidden">
                <SuperAdminSide liname={"My Withdrawal"} />
            </div>
            <div className='w-full h-[100vh] md:overflow-y-hidden mr-[12px] py-[15px]'>
                <SuperAdminNavbar Navtext={"My Withdrawal"} />
...
export default AdminMyWithdrawls;
